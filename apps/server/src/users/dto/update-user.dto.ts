...
export class UpdateUserDto {
  @ApiPropertyOptional({ example: 'João da Silva', description: 'Nome completo', minLength: 2, maxLength: 100 })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: 'usuario@email.com', description: 'E-mail do usuário' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: '+5571999999999', description: 'Telefone no formato internacional' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: 'MALE', description: 'Gênero do usuário', maxLength: 50 })
  @IsOptional()
  @IsString({ message: 'Gênero deve ser texto' })
  @MaxLength(50, { message: 'Gênero deve ter no máximo 50 caracteres' })
  gender?: string;

  @ApiPropertyOptional({ example: 'Rua das Flores, 123, Salvador – BA', description: 'Endereço completo', maxLength: 200 })
  @IsOptional()
  @IsString({ message: 'Endereço deve ser texto' })
  @MaxLength(200, { message: 'Endereço deve ter no máximo 200 caracteres' })
  address?: string;

  @ApiPropertyOptional({ example: '12345678900', description: 'CPF (11–14 chars)', minLength: 11, maxLength: 14 })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: 'Médico com 10 anos de experiência.', description: 'Biografia', maxLength: 500 })
  @IsOptional()
  @IsString({ message: 'Biografia deve ser texto' })
  @MaxLength(500, { message: 'Biografia deve ter no máximo 500 caracteres' })
  bio?: string;

  @ApiPropertyOptional({ example: '/uploads/profile-photos/user-12345.jpg', description: 'URL da foto de perfil' })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    example: { linkedin: 'https://linkedin.com/in/medico', instagram: 'https://instagram.com/medico', other: '' },
  })
  @IsOptional()
  @IsObject()
  socialLinks?: {
