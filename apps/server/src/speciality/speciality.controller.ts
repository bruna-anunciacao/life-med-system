...
export class SpecialityController {
  ...
  @ApiResponse({ status: 200, description: 'Especialidades listadas com sucesso' })
  findAll() {
  ...
  @ApiResponse({ status: 200, description: 'Especialidade encontrada com sucesso' })
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles(UserRole.ADMIN)
  update(@Param('id', ParseUUIDPipe) id: string, @Body() updateSpecialityDto: UpdateSpecialityDto) {
