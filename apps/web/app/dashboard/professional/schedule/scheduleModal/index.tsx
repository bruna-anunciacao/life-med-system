...
const ScheduleModal = ({ isOpen, onOpenChange }: ScheduleModalProps) => {
  ...
  return (
    ...
    >
      <ModalContent className={styles.modalBackground}>
        {() => (
          <div className={styles.modalContainer}>
              ...
              {isLoadingData ? (
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className={styles.field}>
                        ...
                        {errors.price ? (
                          ...
                          <span className={styles.paymentAlert}>
                      ...
                      {currentModality === "CLINIC" && (
                        <div
                          className={`${styles.field} col-span-1 md:col-span-2`}
                        >
                  ...
                  <div>
                    ...
                    <p className={styles.sectionDescription}>
                      Selecione os dias da semana e a janela de horário que você
                      atende.
                    </p>
                    {errors.availability && (
                      <span className="text-red-500 text-xs mb-2 block">
                            ...
                            <label className={styles.dayCheckbox}>
                              ...
                              <span
                                className={`${styles.dayLabel} ${
                                  day.active ? styles.active : styles.inactive
                                }`}
                              >
                                {day.label}
                              </span>
            ...
            <ModalFooter className={styles.modalFooter}>
              <Button
                variant="danger"
                onPress={closeModal}
                isDisabled={isSaving || isLoadingData}
