  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col gap-[0.35rem]">
          <label className="text-[0.85rem] font-semibold text-gray-700">Especialidade Principal</label>
          <select 
            ...
            disabled={!isEditing || loadingSpecialities} 
          ...
          {errors.primarySpecialty && <span className="text-[0.8rem] text-red-600 mt-[0.15rem]">{errors.primarySpecialty.message}</span>}
        </div>
        <div className="flex flex-col gap-[0.35rem]">
          <label className="text-[0.85rem] font-semibold text-gray-700">Subespecialidade <span className="text-gray-400 font-normal">(Opcional)</span></label>
          <select 
            className="px-3 py-[0.6rem] border border-gray-200 rounded-lg bg-white text-[0.95rem] text-gray-900 transition-colors duration-200 appearance-none cursor-pointer focus:outline-none focus:border-[#006fee] focus:shadow-[0_0_0_3px_rgba(0,111,238,0.1)] disabled:bg-gray-50 disabled:text-gray-500 disabled:cursor-not-allowed"
            disabled={!isEditing || loadingSpecialities} 
