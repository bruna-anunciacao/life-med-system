...
const approvalStatusMap: Record<string, { className: string; label: string }> =
  {
    APPROVED: { className: "bg-green-100 text-green-700", label: "Aprovado" },
    PENDING: {
      className: "bg-yellow-100 text-yellow-700",
      label: "Em análise",
    },
    REJECTED: { className: "bg-red-100 text-red-700", label: "Rejeitado" },
  };

type StatusBadgeProps = {
  status: string;
  type?: "user" | "appointment" | "approval";
  className?: string;
};
